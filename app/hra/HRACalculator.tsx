  ...
  return (
    <>
      <div className="md:hidden sticky top-14 z-40 bg-white dark:bg-[#1E293B] border-b border-[#E2E8F0] dark:border-[#334155] px-4 py-3 flex items-center justify-between shadow-sm">
        <div>
          <p className="text-xs text-[#64748B] dark:text-[#94A3B8]">Exempt HRA / month</p>
        ...
        <div className="text-right">
          <p className="text-xs text-[#64748B] dark:text-[#94A3B8]">Taxable HRA</p>
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <div className="bg-white dark:bg-[#1E293B] rounded-2xl p-5 sm:p-6 shadow-sm border border-[#E2E8F0] dark:border-[#334155]">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="font-bold text-[#0F172A] dark:text-[#F1F5F9] text-lg">Your Salary &amp; Rent (monthly)</h2>
          </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="hidden md:block bg-white dark:bg-[#1E293B] rounded-2xl p-6 shadow-sm border border-[#E2E8F0] dark:border-[#334155]">
            <p className="text-sm text-[#64748B] dark:text-[#94A3B8] mb-1">Exempt HRA (per month)</p>
            ...
            <div className="mt-5 grid grid-cols-2 gap-4">
              <div className="bg-green-50 rounded-xl p-3">
                <p className="text-xs text-[#64748B] dark:text-[#94A3B8] mb-1">Exempt / year</p>
              ...
              <div className="bg-red-50 rounded-xl p-3">
                <p className="text-xs text-[#64748B] dark:text-[#94A3B8] mb-1">Taxable / month</p>
          ...
          <div className="bg-white dark:bg-[#1E293B] rounded-2xl p-5 sm:p-6 shadow-sm border border-[#E2E8F0] dark:border-[#334155]">
            <p className="text-sm font-semibold text-[#0F172A] dark:text-[#F1F5F9] mb-1">The 3-condition rule</p>
            <p className="text-xs text-[#94A3B8] mb-3">Your exemption is the lowest of these three.</p>
            <div className="flex flex-col gap-2">
              {rows.map((r) => (
                <div key={r.label} className={`flex items-center justify-between rounded-xl px-4 py-3 border ${r.winner ? "bg-[#F0FDFA] dark:bg-[#042F2E] border-[#0D9488]/30" : "bg-[#F8FAFC] dark:bg-[#0F172A] border-[#E2E8F0] dark:border-[#334155]"}`}>
                  <span className="text-sm text-[#374151] dark:text-[#CBD5E1]">{r.label}</span>
                  <span className={`text-sm font-bold tabular-nums ${r.winner ? "text-[#0D9488] dark:text-[#14B8A6]" : "text-[#0F172A] dark:text-[#F1F5F9]"}`}>
