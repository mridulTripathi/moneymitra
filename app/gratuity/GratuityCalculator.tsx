  ...
  return (
    <>
      <div className="md:hidden sticky top-14 z-40 bg-[var(--bg-card)] border-b border-[var(--border-default)] px-4 py-3 flex items-center justify-between shadow-sm">
        <div>
          <p className="text-xs text-[var(--text-secondary)]">Gratuity Amount</p>
        ...
        <div className="text-right">
          <p className="text-xs text-[var(--text-secondary)]">Tax-free</p>
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <div className="bg-[var(--bg-card)] rounded-2xl p-5 sm:p-6 shadow-sm border border-[var(--border-default)]">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="font-bold text-[var(--text-primary)] text-lg">Service Details</h2>
          </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-[var(--bg-card)] rounded-2xl p-6 shadow-sm border border-[var(--border-default)]">
            {result.eligible ? (
              <>
                <p className="text-sm text-[var(--text-secondary)] mb-1">Gratuity Amount</p>
              ...
              <div className="py-6 text-center">
                ...
                <p className="font-bold text-[var(--text-primary)] mb-1">Not eligible yet</p>
                <p className="text-sm text-[var(--text-secondary)]">Gratuity requires at least 5 years of continuous service. You have {years} year{years !== 1 ? "s" : ""}.</p>
              </div>
            )}
          </div>
